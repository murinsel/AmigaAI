...
SOURCES="src/main.c src/http.c src/claude.c src/json_utils.c src/cJSON.c src/gui.c src/arexx_port.c src/config.c src/memory.c src/tools.c src/dt_identify.c src/locale.c src/input.c src/base64.c src/png_convert.c src/models.c"
