...
- arexx_command: `'opendocument FILE "Work:doc.pgs"'`
- ARexx script: `ADDRESS 'PAGESTREAM'` then `'opendocument FILE "Work:doc.pgs"'`
- WRONG (will fail): `opendocument FILE "Work:doc.pgs"` (missing single quotes!)
